...
public partial class helloBaseListener : IhelloListener {
	/// <summary>
	/// Enter a parse tree produced by <see cref="helloParser.hellofile"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterHellofile([NotNull] helloParser.HellofileContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="helloParser.hellofile"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitHellofile([NotNull] helloParser.HellofileContext context) { }
	/// <summary>
