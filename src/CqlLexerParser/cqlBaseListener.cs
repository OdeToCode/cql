...
public partial class cqlBaseListener : IcqlListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterSingleSourceClause([NotNull] cqlParser.SingleSourceClauseContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="cqlParser.singleSourceClause"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitSingleSourceClause([NotNull] cqlParser.SingleSourceClauseContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="cqlParser.multipleSourceClause"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterMultipleSourceClause([NotNull] cqlParser.MultipleSourceClauseContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="cqlParser.multipleSourceClause"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitMultipleSourceClause([NotNull] cqlParser.MultipleSourceClauseContext context) { }
	/// <summary>
